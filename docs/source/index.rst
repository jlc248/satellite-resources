...
:doc:`Low-Earth orbit` satellites are much closer to the earth (200-1600 km above the surface), and often have instruments with better spatial resolution than their geostationary counterparts. However, their return periods can be considerable -- 12 hours or more. Then phenomena you are interested in will help determin which satellite instrument data to use for your research.
