...
The pair of images below shows the increasing pixel area further away from nadir. The default east position is at 75deg west longitude; the default west position is at 137.5deg west longitude. Within the full-disk image, there is outlined the CONUS/PACUS and mesoscale sector domains. 
